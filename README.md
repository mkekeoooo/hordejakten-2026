...
**Oppdatert 26.09 ca. 16.30: S03-området ligger utenfor default.nos modell.** Sammenlignet med default.nos fusjonsmodell (23.09) ligger S03-klyngen i default.nos **nederste 4 %**. Den er likevel den eneste klyngen i Norge som består alle våre egne, uavhengige tester: regnsekvensen 26.09, seks solhendelser og «NULL REGN» 22.–23.09. Andre klynger utenfor default.no faller på regn 23.09, sol eller skydekke 21.09 (bl.a. Trøndelag). Ingen kjente feltpunkter fra default.no ligger innen 5 km. Eneste test området ikke består: 21.29-gesten, *hvis* den gjaldt et fly, som ikke alene utelukker noe ([#9](https://github.com/mkekeoooo/hordejakten-2026/issues/9)). [#14](https://github.com/mkekeoooo/hordejakten-2026/issues/14) · **[Kortliste for bildekontroll: 18 skogklynger i kjernen 60,54–60,59 / 12,13–12,19 med ankomst fra ca. 129° oppover](https://github.com/mkekeoooo/hordejakten-2026/issues/14#issuecomment-5846777309)**. Topp 3 ligger ca. 2 km vest-nordvest for S03, der regnsamsvaret er sterkest. Ingen er bekreftet, og hvert punkt har mange like naboer.
